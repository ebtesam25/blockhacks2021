...
export default function Published({route}) {
    ...
    return (
        <View style={styles.contain}>
           ...
           <Icon name="check-circle" type="fa" color="#0553B9" size={100}></Icon>
           <Text style={styles.title}>{type=='new' ? 'Your NFT has been published!': 'Your NFT is now on the market for sale!'}</Text>
            <Text style={styles.subtitle}>NFT ID #{data.id}. Keep an eye on your notifications for updates</Text>
