    ...
    return (
        <View style={styles.contain}>
           ...
           <View style={{marginTop:'15%'}}></View>
            ...
            <Text style={styles.subtitle}>Upload a valid ID</Text>
            <View style={styles.horizontal}>
            ...
            <View style={{marginLeft:'0%'}}>
                ...
                <View style={styles.field}>
                    <TextInput placeholder="Include country code" style={{fontWeight:'bold', color:"#0553B9"}} value={personal.mobile} onChangeText={(e)=>{setPersonal(info => ({...info,mobile: e}))}}></TextInput>
                </View>
                <Text style={styles.subtitle}>Social Security Number</Text>
                
                <View style={styles.field}>
                    <TextInput placeholder="XXX-XXX-XXX" style={{fontWeight:'bold', color:"#0553B9"}} value={personal.mobile} onChangeText={(e)=>{setPersonal(info => ({...info,mobile: e}))}}></TextInput>
                </View>
                <Text style={styles.subtitle}>ITIN Number</Text>
                ...
                <View style={{marginTop:'10%'}}></View>
                <TouchableOpacity onPress={()=>{navigation.navigate('Payment')}}><View style={styles.btnxl}><Text style={{fontSize:18, color:"#FFF", fontWeight:'bold', textAlign:'center', textAlignVertical:'center', marginTop:'3.5%'}}>Continue</Text></View></TouchableOpacity>
            </View>
