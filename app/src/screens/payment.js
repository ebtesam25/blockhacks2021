        ...
        <View style={styles.contain}>
           ...
           <View style={{marginTop:'15%'}}></View>
            ...
            <View style={{marginLeft:'0%'}}>
                ...
                <TouchableOpacity onPress={()=>{setNewNFT(nft => ({...nft,type: 'sale'}))}}><View style={styles.btnxl}><Text style={{fontSize:18, color:"#FFF", fontWeight:'bold', textAlign:'center', textAlignVertical:'center', marginTop:'3.5%'}}>Confirm</Text></View></TouchableOpacity>
            </View>
